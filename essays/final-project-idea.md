...
New or default user goes to landing page, goes to project list, selects and views project review
...
A way to update all project forms for new parameters added
Default values for parameters
Search system for projects rather than list based on project tabs
